    ...
    <div id="projects">
      ...
      <Row className="individual-project">
        <Col className="img-project">
          <img className="rounded" src={proj1} />
        </Col>
        <Col className="project1-info project-info">
          ...
          <div className="links-projects">
            <Button variant="primary">
              <a
                href="https://github.com/Nievas1000/Videogame-Store----NextJs"
                target="_blank"
              >
                Ir al repositorio{" "}
      ...
      <Row className="individual-project">
        ...
        <Col className="img-project">
          <img className="rounded" src={proj2} />
        </Col>
      </Row>
      <Row className="individual-project">
        <Col className="img-project">
          <img className="rounded" src={proj3} />
        </Col>
        <Col className="project1-info project-info">
          ...
          <div className="links-projects">
            <Button variant="primary">
              <a
                href="https://github.com/Nievas1000/API-UNIVERSITY"
                target="_blank"
              >
                Ir al repositorio{" "}
                <i className="fa fa-github" aria-hidden="true"></i>
